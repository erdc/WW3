...
MODULE W3GDATMD
  ...
  TYPE SCHM
    ...
    INTEGER :: ISETUP_STP = 2
    REAL(8) :: CRIT_DEP_STP
    REAL(8) :: STP_DT_PSEUDO  = 1.0D6
    INTEGER :: STP_MAX_OUTER  = 100
    INTEGER :: STP_MAX_INNER  = 20
    REAL(8) :: STP_TOL_OUTER  = 1.0D-10
    REAL(8) :: STP_TOL_INNER  = 1.0D-8
  ...
  INTEGER, POINTER  :: ISETUP_STP
  REAL(8), POINTER  :: CRIT_DEP_STP
  REAL(8), POINTER  :: STP_DT_PSEUDO
  INTEGER, POINTER  :: STP_MAX_OUTER
  INTEGER, POINTER  :: STP_MAX_INNER
  REAL(8), POINTER  :: STP_TOL_OUTER
  REAL(8), POINTER  :: STP_TOL_INNER
...
9003 FORMAT (' TEST W3DIMS : DIMENSIONS STORED')
  ...
  SUBROUTINE W3SETG ( IMOD, NDSE, NDST )
    ...
    ISETUP_STP => MPARS(IMOD)%SCHMS%ISETUP_STP
    CRIT_DEP_STP => MPARS(IMOD)%SCHMS%CRIT_DEP_STP
    STP_DT_PSEUDO => MPARS(IMOD)%SCHMS%STP_DT_PSEUDO
    STP_MAX_OUTER => MPARS(IMOD)%SCHMS%STP_MAX_OUTER
    STP_MAX_INNER => MPARS(IMOD)%SCHMS%STP_MAX_INNER
    STP_TOL_OUTER => MPARS(IMOD)%SCHMS%STP_TOL_OUTER
    STP_TOL_INNER => MPARS(IMOD)%SCHMS%STP_TOL_INNER
