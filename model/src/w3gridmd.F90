...
MODULE W3GRIDMD
  ...
  INTEGER :: ISETUP_SETUP
  REAL*8  :: CRIT_DEP_SETUP
  REAL*8  :: SETUP_DT_PSEUDO
  INTEGER :: SETUP_MAX_OUTER
  INTEGER :: SETUP_MAX_INNER
  REAL*8  :: SETUP_TOL_OUTER
  REAL*8  :: SETUP_TOL_INNER
  !
  ...
  NAMELIST /UNST/ UGOBCAUTO, UGOBCDEPTH, UGOBCFILE,          &
       ...
       ISETUP_SETUP, CRIT_DEP_SETUP,             &
       SETUP_DT_PSEUDO, SETUP_MAX_OUTER,          &
       SETUP_MAX_INNER, SETUP_TOL_OUTER,           &
       SETUP_TOL_INNER
...
CONTAINS
  ...
  SUBROUTINE W3GRID()
    ...
    ISETUP_SETUP=2
    CRIT_DEP_SETUP=0.1
    SETUP_DT_PSEUDO=1.0D6
    SETUP_MAX_OUTER=100
    SETUP_MAX_INNER=20
    SETUP_TOL_OUTER=1.0D-10
    SETUP_TOL_INNER=1.0D-8
    ...
    IF ( GTYPE.EQ.UNGTYPE) THEN
      ...
      ISETUP_STP = ISETUP_SETUP
      CRIT_DEP_STP  = CRIT_DEP_SETUP
      STP_DT_PSEUDO = SETUP_DT_PSEUDO
      STP_MAX_OUTER = SETUP_MAX_OUTER
      STP_MAX_INNER = SETUP_MAX_INNER
      STP_TOL_OUTER = SETUP_TOL_OUTER
      STP_TOL_INNER = SETUP_TOL_INNER
    END IF
