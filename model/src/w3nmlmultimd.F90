...
MODULE W3NMLMULTIMD
  ...
  TYPE NML_MODEL_FORCING_T
    ...
    CHARACTER(13)               :: VEG_PARAM1
    CHARACTER(13)               :: VEG_PARAM2
...
CONTAINS
  ...
  SUBROUTINE READ_INPUT_GRID_NML (NDSI, NRINP, NML_INPUT_GRID)
    ...
    DO I = 1,NRINP
      ...
      INPUT(I)%FORCING%VEGETATION    = .FALSE.
      ...
      INPUT(I)%FORCING%VEG_PARAM1    = .FALSE.
      INPUT(I)%FORCING%VEG_PARAM2    = .FALSE.
...
10  FORMAT (A,I0,A)
  ...
  SUBROUTINE READ_MODEL_GRID_NML (NDSI, NRGRD, NML_MODEL_GRID)
    ...
    DO I = 1,NRGRD
      ...
      MODEL(I)%FORCING%VEG_PARAM1    = 'no'
      MODEL(I)%FORCING%VEG_PARAM2    = 'no'
...
13  FORMAT (A,2X,A,L1)
  ...
  SUBROUTINE REPORT_INPUT_GRID_NML (NRINP, NML_INPUT_GRID)
    ...
    DO I = 1,NRINP
      ...
      WRITE (NDSN,13) TRIM(MSG),'FORCING % VEGETATION     = ', NML_INPUT_GRID(I)%FORCING%VEGETATION
      ...
      WRITE (NDSN,13) TRIM(MSG),'FORCING % VEG_PARAM1     = ', NML_INPUT_GRID(I)%FORCING%VEG_PARAM1
      WRITE (NDSN,13) TRIM(MSG),'FORCING % VEG_PARAM2     = ', NML_INPUT_GRID(I)%FORCING%VEG_PARAM2
...
13  FORMAT (A,2X,A,L1)
  ...
  SUBROUTINE REPORT_MODEL_GRID_NML (NRGRD, NML_MODEL_GRID)
    ...
    DO I = 1,NRGRD
      ...
      WRITE (NDSN,10) TRIM(MSG),'FORCING % VEGETATION     = ', TRIM(NML_MODEL_GRID(I)%FORCING%VEGETATION)
      ...
      WRITE (NDSN,10) TRIM(MSG),'FORCING % VEG_PARAM1     = ', TRIM(NML_MODEL_GRID(I)%FORCING%VEG_PARAM1)
      WRITE (NDSN,10) TRIM(MSG),'FORCING % VEG_PARAM2     = ', TRIM(NML_MODEL_GRID(I)%FORCING%VEG_PARAM2)
