...
!/ ------------------------------------------------------------------- /
  ...
  TYPE NML_FORCING_T
    ...
    CHARACTER(13)               :: VEG_PARAMS
    CHARACTER(13)               :: VEG_CDRAG
...
!/ ------------------------------------------------------------------- /
    ...
    INPUT%FORCING%VEG_PARAMS    = 'F'
    INPUT%FORCING%VEG_CDRAG     = 'F'
    INPUT%ASSIM%MEAN            = 'F'
...
!/ ------------------------------------------------------------------- /
    ...
    WRITE (NDSN,10) TRIM(MSG),'FORCING % VEGETATION     = ', NML_INPUT%FORCING%VEGETATION
    ...
    WRITE (NDSN,10) TRIM(MSG),'FORCING % VEG_PARAMS     = ', NML_INPUT%FORCING%VEG_PARAMS
    WRITE (NDSN,10) TRIM(MSG),'FORCING % VEG_CDRAG      = ', NML_INPUT%FORCING%VEG_CDRAG
...
!/ ------------------------------------------------------------------- /
    ...
    WRITE (NDSN,11) TRIM(MSG),'N_VEG       = ', NML_HOMOG_COUNT%N_VEG
