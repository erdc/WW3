...
CONTAINS
  ...
  SUBROUTINE READ_FORCING_NML (NDSI, NML_FORCING)
    ...
    !
    FORCING%FIELD%VEG_PARAMS     = .FALSE.
    ...
    FORCING%FIELD%VEGETATION     = .FALSE.
  ...
  SUBROUTINE REPORT_FORCING_NML (NML_FORCING)
    ...
    WRITE (NDSN,13) TRIM(MSG),'FIELD % VEG_PARAMS     = ', NML_FORCING%FIELD%VEG_PARAMS
    ...
    WRITE (NDSN,13) TRIM(MSG),'FIELD % VEGETATION     = ', NML_FORCING%FIELD%VEGETATION
